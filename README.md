...
# [CLIMGeno V.2.0](https://rstudio.aws.science.psu.edu:3838/aaf11/CLIMGeno/ "CLIMGeno V.2.0")
...
Navigation through the graphs and tables in [CLIMGeno V.2.0](https://rstudio.aws.science.psu.edu:3838/aaf11/CLIMGeno/ "CLIMGeno V.2.0") is done using the tabs at the top of the page, adjusting options on the sidebar panel, or clicking points on the plots. The user interface is designed to be intuitive and allow the user to quickly zoom into a point of interest anywhere on the genome.
